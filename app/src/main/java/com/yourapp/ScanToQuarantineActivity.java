...
public class ScanToQuarantineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_to_quarantine);

        qrInput = findViewById(R.id.qr_code_quarantine);
        scanBtn = findViewById(R.id.scanBtnQuarantine);
    ...
    private void processScan(String qrCode) {
        ...
        Request request = new Request.Builder()
                .url(BASE_URL + "scan_quarantine_process.php")
                .post(body)
                .build();
        ...
        apiClient.getClient().newCall(request).enqueue(new Callback() {
            @Override public void onFailure(@NonNull Call call, @NonNull IOException e) {
                runOnUiThread(() ->
                        Toast.makeText(ScanToQuarantineActivity.this, "Network error", Toast.LENGTH_SHORT).show()
                );
            }
            ...
            @Override public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                try {
                    ...
                    runOnUiThread(() -> {
                        Toast.makeText(ScanToQuarantineActivity.this, message, Toast.LENGTH_LONG).show();
                    ...
                    runOnUiThread(() ->
                            Toast.makeText(ScanToQuarantineActivity.this, "Invalid response", Toast.LENGTH_SHORT).show()
                    );
                }
            }
        });
    ...
    private void loadLastScans() {
        Request request = new Request.Builder()
                .url(BASE_URL + "scan_quarantine_last10.php")
                .build();
        ...
        apiClient.getClient().newCall(request).enqueue(new Callback() {
            ...
            @Override public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                runOnUiThread(() -> {
                    ...
                    // parse or render HTML (depends on your style)
                });
            }
        });
    }
